...
const Cart = () => {
  ...
  const {products, user, currency, cartItems,setCartItems, removeFromCart,getCartCount, updateCartItem, navigate, getCartAmount, axios} = useAppContext();
...
const getUserAddresses = async () => {
  try {
    ...
    toast.error("Something went wrong while fetching addresses", error.message);
  }
}
